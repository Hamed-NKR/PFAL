...
%           0% |                    |
% 
%   UTILS.TEXTBAR(pct) displays a textbar with the provided percentage, 
%       removing text corresponding to the previous textbar.  
%       For example, textbar(0.1) yields:
%           10% |██                  |
% 
%   UTILS.TEXTBAR([i(1), i(2)]) displays a textbar with an appended 
...
%           10% |██                  | 1/10
% 
%   UTILS.TEXTBAR([i(1), i(2), i(3), i(4), ...]) displays a textbar considering
...
%           27% |█████▌              | 4/15
%    
%   UTILS.TEXTBAR(..., f_back) displays a textbar with control over whether  
...
%  Please see github.com/tsipkens/atems for an original version.
