...
figure_cfg = struct( ...
    ...
    'position', [200 150 1000 1200], ...
    'x_scale', 'linear', ...
    'y_scale', 'linear', ...
    'x_limits', [-100 100], ...
    'y_limits', [0.5 110], ...
    'x_ticks', -100:20:100, ...
    'x_minor_ticks', -90:20:90, ...
    ...
    'legend', struct('location', 'eastoutside', ...
        ...
        'interpreter', 'tex'), ...
    'grid', struct('x_major', true, 'x_minor', true, ...
        'y_major', false, 'major_color', '#D9D9D9', ...
        'minor_color', '#EEEEEE', 'major_alpha', 0.65, ...
        'minor_alpha', 0.50, 'major_line_style', '-', ...
        'minor_line_style', ':'), ...
